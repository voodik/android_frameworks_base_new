        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            if (mInfo == null) {
                ...
                if (mBuiltInDisplayId == SurfaceControl.BUILT_IN_DISPLAY_ID_MAIN) {
                    ...
                    if ("portrait".equals(SystemProperties.get("persist.demo.hdmirotation", "landscape"))) {
			if ((SystemProperties.getInt("ro.sf.hwrotation",0)) == 90){
                            mInfo.rotation = Surface.ROTATION_90;
                        } else {
                        mInfo.rotation = Surface.ROTATION_270;
                        }
                    } else if ("landscape".equals(SystemProperties.get("persist.demo.hdmirotation", "landscape"))) {
